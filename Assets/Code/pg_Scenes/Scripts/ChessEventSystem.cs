...
public class ChessEventSystem : MonoBehaviour
{

    private Dictionary<string, UnityEvent> eventDictionary;
    private Dictionary<string, TypedEvent> typedEventDictionary;

    private static ChessEventSystem eventManager;

    public static ChessEventSystem instance
    {
        get
        {
            if (!eventManager)
            {
                eventManager = FindAnyObjectByType(typeof(ChessEventSystem)) as ChessEventSystem;
